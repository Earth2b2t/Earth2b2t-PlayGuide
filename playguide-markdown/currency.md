...
毎日更新されるクエストを達成することでSCを入手できます。1日に更新されるクエストの数は3つまでです。
...
#### 他国家から奪う
[**戦争**](/guide/war)で他国家からNCを奪いましょう。戦争に勝利すると[**賠償金**](/guide/afterwar)としてNCを入手できます。

#### SCから変換する
SCを所持している場合は、```/n convert [数値]```を実行することでNCに変換できます。レートは10分の1となっており、1000SCを変換すると100NCとなります。
